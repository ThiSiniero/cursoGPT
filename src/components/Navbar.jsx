  ...
  return (
    <nav>
      <div className={`border-b lg:border-none border-gray-600 flex flex-col lg:flex-row justify-between items-center lg:py-4 py-10 mb-8 ${theme === "dark" ? "bg-gray-500 text-white" : "bg-gray-300 text-black"} font-bold`}>
        ...
        <div className={`${isOpen ? "block mt-8 lg:mt-4 " : "hidden"} items-center border-t lg:border-none pt-10 lg:pt-0 border-gray-600 lg:flex flex-col lg:flex-row  lg:space-x-4 lg:pl-20 w-full lg:w-auto px-4 lg:px-0 text-center`}>
          <Link className="px-4 lg:px-8 py-2 lg:py-0 lg:text-lg text-2xl" to="/">Home</Link>
