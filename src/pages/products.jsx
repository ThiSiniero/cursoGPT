  ...
  return (
    <div className="p-4 sm:p-6">
      <div className="flex flex-row justify-between items-center mb-4">
        <h1 className="lg:text-3xl text-5xl font-bold mb-6">Nossos Produtos</h1>
        <select className="p-2 text-lg lg:text-base rounded-t-xl" onChange={(e) => setCategory(e.target.value)} value={category}>
