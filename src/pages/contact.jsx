    ...
    return <>
        <div className="flex items-center justify-center rounded-lg">
            ...
            <div className="p-6 text-center">   
                ...
                <p className="max-w-7xl"> ipsum dolor sit amet, consectetur adipisicing elit. Pariatur eius dolor qui harum, quidem aspernatur officiis temporibus, voluptas perspiciatis consequatur neque earum obcaecati repellendus odio quo placeat provident nam aliquam.</p>
                <h2 className="text-2xl font-bold py-2">Nosso Contato:</h2>
                <p className="text-lg py-2">(11) 93406-3746</p>
            </div>
